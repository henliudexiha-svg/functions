...
execute as @e[family=mob,name="§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 1..8000 run structure load "ddcr" ~ ~0.5 ~
execute as @e[family=mob,name="§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 1..6000 run structure load "ddcr" ~ ~0.5 ~
execute as @e[family=mob,name="§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 1..4000 run structure load "ddcr" ~ ~0.5 ~
execute as @e[family=mob,name="§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 1..2000 run structure load "ddcr" ~ ~0.5 ~
execute as @e[family=mob,name="§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 1..1000 run structure load "ddcr" ~ ~0.5 ~
...
execute as @e[family=mob,name="§r§j百年§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 1..2000 run structure load "bnddc1"~ ~0.5 ~
execute as @e[family=mob,name="§r§j百年§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 2500..4000 run structure load "bnddc2"~ ~0.5 ~
execute as @e[family=mob,name="§r§j百年§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 1500..3000 run structure load "bnddc2"~ ~0.5 ~
execute as @e[family=mob,name="§r§j百年§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 2500..8000 run structure load "bnddc4"~ ~0.5 ~
execute as @e[family=mob,name="§r§j百年§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 2500..5000 run structure load "bnddc4"~ ~0.5 ~
execute as @e[family=mob,name="§r§j百年§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 2500..3000 run structure load "bnddc4"~ ~0.5 ~

execute as @e[family=mob,name="§r§j百年§7§l蠹蠹虫",scores={hp=..0}] at @s if score @s gwrand matches 1..200 run structure load "bnddc3"~ ~0.5~
...
execute as @e[family=mob,name="§a树精",scores={hp=..0}] at @s if score @s gwrand matches 1..3000 run structure load "sjdlw1" ~ ~0.5 ~
execute as @e[family=mob,name="§a树精",scores={hp=..0}] at @s if score @s gwrand matches 1..1000 run structure load "sjdlw1" ~ ~0.5 ~
execute as @e[family=mob,name="§a树精",scores={hp=..0}] at @s if score @s gwrand matches 2500..5000 run structure load "sjdlw2" ~ ~0.5 ~
execute as @e[family=mob,name="§a树精",scores={hp=..0}] at @s if score @s gwrand matches 2500..4000 run structure load "sjdlw2" ~ ~0.5 ~
execute as @e[family=mob,name="§a树精",scores={hp=..0}] at @s if score @s gwrand matches 2500..4000 run structure load "sjdlw2" ~ ~0.5 ~
