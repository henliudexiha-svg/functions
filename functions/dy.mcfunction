...
execute  as @a[hasitem={item=minecraft:golden_apple,location=slot.weapon.mainhand,data=0},rxm=89,scores={dj=0..13}] run scoreboard players add @s jy 10
execute  as @a[hasitem={item=minecraft:golden_apple,location=slot.weapon.mainhand,data=0},rxm=89,scores={dj=0..13}] run scoreboard players add @s hp 100
execute  as @a[hasitem={item=minecraft:golden_apple,location=slot.weapon.mainhand,data=0},rxm=89,scores={dj=0..13}] run scoreboard players add @s shxs 200
execute  as @a[hasitem={item=minecraft:golden_apple,location=slot.weapon.mainhand,data=0},rxm=89,scores={dj=0..13}] at @s run playsound random.eat @s ~~~ 1 0.8 1
execute  as @a[hasitem={item=minecraft:golden_apple,location=slot.weapon.mainhand,data=0},rxm=89,scores={dj=0..13}] run effect @s slowness 1 2 true
execute  as @a[hasitem={item=minecraft:golden_apple,location=slot.weapon.mainhand,data=0},rxm=89,scores={dj=0..13}] run effect @s speed 120 0 true
execute  as @a[hasitem={item=minecraft:golden_apple,location=slot.weapon.mainhand,data=0},rxm=89,scores={dj=0..13}] run clear @s golden_apple 0 1 

# 附魔金苹果：高额修为、回血和伤害吸收，并给长期速度效果。
execute  as @a[hasitem={item=minecraft:enchanted_golden_apple,location=slot.weapon.mainhand,data=0},rxm=89] run scoreboard players add @s jy 1000
execute  as @a[hasitem={item=minecraft:enchanted_golden_apple,location=slot.weapon.mainhand,data=0},rxm=89] run scoreboard players add @s hp 10000
execute  as @a[hasitem={item=minecraft:enchanted_golden_apple,location=slot.weapon.mainhand,data=0},rxm=89] run scoreboard players add @s shxs 5000
execute  as @a[hasitem={item=minecraft:enchanted_golden_apple,location=slot.weapon.mainhand,data=0},rxm=89] at @s run playsound random.eat @s ~~~ 1 0.8 1
execute  as @a[hasitem={item=minecraft:enchanted_golden_apple,location=slot.weapon.mainhand,data=0},rxm=89] run effect @s slowness 1 2 true
execute  as @a[hasitem={item=minecraft:enchanted_golden_apple,location=slot.weapon.mainhand,data=0},rxm=89] run effect @s speed infinite 1 true 
execute  as @a[hasitem={item=minecraft:enchanted_golden_apple,location=slot.weapon.mainhand,data=0},rxm=89] run clear @s enchanted_golden_apple 0 1 
#练气丹
