...
scoreboard players set @a[scores={cd=6..}] cd 1
kill @e[type=minecraft:snowball]


#显示
execute as @a[scores={cd=1..6}] at @s run titleraw @s actionbar {"rawtext":[{"text":"  §d༺§c✿§f玄黄§b༒§f纪元§c✿§d༻\n§e====================\n"},{"translate":"%%2『返回主城』","with":{"rawtext":[{"selector":"@s[scores={cd=1}]"},{"text":"   §g➮§c"},{"text":"§r     "}]}},{"translate":"\n%%2『自刎归天』","with":{"rawtext":[{"selector":"@s[scores={cd=2}]"},{"text":"   §g➭§c"},{"text":"§r     "}]}},{"translate":"\n%%2『个人信息』","with":{"rawtext":[{"selector":"@s[scores={cd=3}]"},{"text":"   §g➭§c"},{"text":"§r     "}]}},{"translate":"\n%%2『属性恢复』","with":{"rawtext":[{"selector":"@s[scores={cd=4}]"},{"text":"   §g➭§c"},{"text":"§r     "}]}},{"translate":"\n%%2『散去功法』","with":{"rawtext":[{"selector":"@s[scores={cd=5}]"},{"text":"   §g➮§c"},{"text":"§r     "}]}},{"text":"\n§r§e====================\n§a抬头确认   低头取消"}]}
